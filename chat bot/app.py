...
def query():
    ...
    if user_input.lower() == "exit":
        response = "Thank you for using Education Placement Assistant. Visit again!"
    else:
        ...
        if is_relevant:
            response = palm.chat(messages=user_input).last
        else:
            response = "While my focus is on education placements, interview help, and technical skills, I'm still learning. How can I assist you today in these areas?"
